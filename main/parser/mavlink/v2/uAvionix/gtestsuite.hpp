...
TEST(uAvionix_interop, UAVIONIX_ADSB_OUT_CFG) {
  ...
  mavlink_uavionix_adsb_out_cfg_t packet_c{963497464, 17443, "GHIJKLMN", 242,
                                           53,        120,   187,        254};
...
TEST(uAvionix_interop, UAVIONIX_ADSB_OUT_DYNAMIC) {
  ...
  mavlink_uavionix_adsb_out_dynamic_t packet_c{
      ...
      18483,     18587,     18691,     18795,     18899,     19003,
      19107,     247,       58,        125};
...
TEST(uAvionix_interop, UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT) {
  ...
  mavlink_uavionix_adsb_transceiver_health_report_t packet_c{5};
  ...
  mavlink_msg_uavionix_adsb_transceiver_health_report_encode(1, 1, &msg,
                                                             &packet_c);
