...
TEST(ardupilotmega_interop, SENSOR_OFFSETS) {
  ...
  mavlink_sensor_offsets_t packet_c{17.0,  963497672, 963497880, 101.0,
                                    129.0, 157.0,     185.0,     213.0,
                                    241.0, 19107,     19211,     19315};
...
TEST(ardupilotmega_interop, SET_MAG_OFFSETS) {
  ...
  mavlink_set_mag_offsets_t packet_c{17235, 17339, 17443, 151, 218};
...
TEST(ardupilotmega_interop, MEMINFO) {
  ...
  mavlink_meminfo_t packet_c{17235, 17339, 963497672};
...
TEST(ardupilotmega_interop, AP_ADC) {
  ...
  mavlink_ap_adc_t packet_c{17235, 17339, 17443, 17547, 17651, 17755};
...
TEST(ardupilotmega_interop, DIGICAM_CONFIGURE) {
  ...
  mavlink_digicam_configure_t packet_c{17.0, 17443, 151, 218, 29, 96,
                                       163,  230,   41,  108, 175};
...
TEST(ardupilotmega_interop, DIGICAM_CONTROL) {
  ...
  mavlink_digicam_control_t packet_c{17.0, 17, 84,  151, 218,
                                     29,   96, 163, 230, 41};
...
TEST(ardupilotmega_interop, MOUNT_CONFIGURE) {
  ...
  mavlink_mount_configure_t packet_c{5, 72, 139, 206, 17, 84};
...
TEST(ardupilotmega_interop, MOUNT_CONTROL) {
  ...
  mavlink_mount_control_t packet_c{963497464, 963497672, 963497880,
                                   41,        108,       175};
...
TEST(ardupilotmega_interop, MOUNT_STATUS) {
  ...
  mavlink_mount_status_t packet_c{963497464, 963497672, 963497880, 41, 108};
...
TEST(ardupilotmega_interop, FENCE_POINT) {
  ...
  mavlink_fence_point_t packet_c{17.0, 45.0, 29, 96, 163, 230};
...
TEST(ardupilotmega_interop, FENCE_FETCH_POINT) {
  ...
  mavlink_fence_fetch_point_t packet_c{5, 72, 139};
...
TEST(ardupilotmega_interop, AHRS) {
  ...
  mavlink_ahrs_t packet_c{17.0, 45.0, 73.0, 101.0, 129.0, 157.0, 185.0};
...
TEST(ardupilotmega_interop, SIMSTATE) {
  ...
  mavlink_simstate_t packet_c{17.0,  45.0,  73.0,  101.0,     129.0,    157.0,
                              185.0, 213.0, 241.0, 963499336, 963499544};
...
TEST(ardupilotmega_interop, HWSTATUS) {
  ...
  mavlink_hwstatus_t packet_c{17235, 139};
...
TEST(ardupilotmega_interop, RADIO) {
  ...
  mavlink_radio_t packet_c{17235, 17339, 17, 84, 151, 218, 29};
...
TEST(ardupilotmega_interop, WIND) {
  ...
  mavlink_wind_t packet_c{17.0, 45.0, 73.0};
...
TEST(ardupilotmega, DATA16) {
  ...
  packet_in.type = 5;
  packet_in.len = 72;
  packet_in.data = {{139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150,
                     151, 152, 153, 154}};
...
TEST(ardupilotmega, DATA32) {
  ...
  packet_in.type = 5;
  packet_in.len = 72;
  packet_in.data = {{139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149,
...
TEST(ardupilotmega_interop, DATA32) {
  ...
  mavlink_data32_t packet_c{
      5, 72, {139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149,
              150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160,
              161, 162, 163, 164, 165, 166, 167, 168, 169, 170}};
...
TEST(ardupilotmega_interop, DATA96) {
  ...
  mavlink_data96_t packet_c{
      5, 72, {139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150,
...
TEST(ardupilotmega_interop, RANGEFINDER) {
  ...
  mavlink_rangefinder_t packet_c{17.0, 45.0};
...
TEST(ardupilotmega_interop, AIRSPEED_AUTOCAL) {
  ...
  mavlink_airspeed_autocal_t packet_c{17.0,  45.0,  73.0,  101.0, 129.0, 157.0,
                                      185.0, 213.0, 241.0, 269.0, 297.0, 325.0};
...
TEST(ardupilotmega_interop, RALLY_POINT) {
  ...
  mavlink_rally_point_t packet_c{963497464, 963497672, 17651, 17755, 17859,
                                 175,       242,       53,    120,   187};
...
TEST(ardupilotmega_interop, RALLY_FETCH_POINT) {
  ...
  mavlink_rally_fetch_point_t packet_c{5, 72, 139};
...
TEST(ardupilotmega_interop, COMPASSMOT_STATUS) {
  ...
  mavlink_compassmot_status_t packet_c{17.0, 45.0, 73.0, 101.0, 18067, 18171};
...
TEST(ardupilotmega_interop, AHRS2) {
  ...
  mavlink_ahrs2_t packet_c{17.0, 45.0, 73.0, 101.0, 963498296, 963498504};
...
TEST(ardupilotmega_interop, CAMERA_FEEDBACK) {
  ...
  mavlink_camera_feedback_t packet_c{93372036854775807ULL,
                                     963497880,
                                     963498088,
                                     129.0,
                                     157.0,
...
TEST(ardupilotmega_interop, BATTERY2) {
  ...
  mavlink_battery2_t packet_c{17235, 17339};
...
TEST(ardupilotmega_interop, AHRS3) {
  ...
  mavlink_ahrs3_t packet_c{17.0,      45.0,  73.0,  101.0, 963498296,
                           963498504, 185.0, 213.0, 241.0, 269.0};
...
TEST(ardupilotmega_interop, AUTOPILOT_VERSION_REQUEST) {
  ...
  mavlink_autopilot_version_request_t packet_c{5, 72};
...
TEST(ardupilotmega_interop, REMOTE_LOG_BLOCK_STATUS) {
  ...
  mavlink_remote_log_block_status_t packet_c{963497464, 17, 84, 151};
...
TEST(ardupilotmega, LED_CONTROL) {
  ...
  packet_in.custom_bytes = {{84,  85,  86,  87,  88,  89,  90,  91,
...
TEST(ardupilotmega_interop, LED_CONTROL) {
  ...
  mavlink_led_control_t packet_c{
      5, 72, 139, 206, 17, {84,  85,  86,  87,  88,  89,  90,  91,
                            92,  93,  94,  95,  96,  97,  98,  99,
                            100, 101, 102, 103, 104, 105, 106, 107}};
...
TEST(ardupilotmega_interop, MAG_CAL_PROGRESS) {
  ...
  mavlink_mag_cal_progress_t packet_c{
      17.0, 45.0, 73.0,
      41,   108,  175,
      242,  53,   {120, 121, 122, 123, 124, 125, 126, 127, 128, 129}};
...
TEST(ardupilotmega_interop, MAG_CAL_REPORT) {
  ...
  mavlink_mag_cal_report_t packet_c{17.0,  45.0,  73.0,  101.0, 129.0, 157.0,
                                    185.0, 213.0, 241.0, 269.0, 125,   192,
                                    3,     70,    325.0, 149,   216,   367.0};
...
TEST(ardupilotmega_interop, EKF_STATUS_REPORT) {
  ...
  mavlink_ekf_status_report_t packet_c{17.0,  45.0,  73.0, 101.0,
                                       129.0, 18275, 171.0};
...
TEST(ardupilotmega_interop, PID_TUNING) {
  ...
  mavlink_pid_tuning_t packet_c{17.0, 45.0, 73.0, 101.0, 129.0, 157.0, 77};
...
TEST(ardupilotmega_interop, DEEPSTALL) {
  ...
  mavlink_deepstall_t packet_c{963497464, 963497672, 963497880, 963498088,
                               963498296, 963498504, 185.0,     213.0,
                               241.0,     113};
  ...
  EXPECT_EQ(packet_in.altitude, packet2.altitude);
  EXPECT_EQ(packet_in.expected_travel_distance,
            packet2.expected_travel_distance);
...
TEST(ardupilotmega_interop, GIMBAL_REPORT) {
  ...
  mavlink_gimbal_report_t packet_c{17.0,  45.0,  73.0,  101.0, 129.0, 157.0,
                                   185.0, 213.0, 241.0, 269.0, 125,   192};
...
TEST(ardupilotmega_interop, GIMBAL_CONTROL) {
  ...
  mavlink_gimbal_control_t packet_c{17.0, 45.0, 73.0, 41, 108};
...
TEST(ardupilotmega_interop, GIMBAL_TORQUE_CMD_REPORT) {
  ...
  mavlink_gimbal_torque_cmd_report_t packet_c{17235, 17339, 17443, 151, 218};
...
TEST(ardupilotmega_interop, GOPRO_HEARTBEAT) {
  ...
  mavlink_gopro_heartbeat_t packet_c{5, 72, 139};
...
TEST(ardupilotmega_interop, GOPRO_GET_REQUEST) {
  ...
  mavlink_gopro_get_request_t packet_c{5, 72, 139};
...
TEST(ardupilotmega_interop, GOPRO_GET_RESPONSE) {
  ...
  mavlink_gopro_get_response_t packet_c{5, 72, {139, 140, 141, 142}};
...
TEST(ardupilotmega_interop, GOPRO_SET_REQUEST) {
  ...
  mavlink_gopro_set_request_t packet_c{5, 72, 139, {206, 207, 208, 209}};
...
TEST(ardupilotmega_interop, GOPRO_SET_RESPONSE) {
  ...
  mavlink_gopro_set_response_t packet_c{5, 72};
...
TEST(ardupilotmega, EFI_STATUS) {
  ...
  EXPECT_EQ(packet1.intake_manifold_temperature,
            packet2.intake_manifold_temperature);
  EXPECT_EQ(packet1.cylinder_head_temperature,
            packet2.cylinder_head_temperature);
...
TEST(ardupilotmega_interop, EFI_STATUS) {
  ...
  mavlink_efi_status_t packet_c{17.0,  45.0,  73.0,  101.0, 129.0, 157.0,
                                185.0, 213.0, 241.0, 269.0, 297.0, 325.0,
                                353.0, 381.0, 409.0, 437.0, 197};
  ...
  EXPECT_EQ(packet_in.intake_manifold_pressure,
            packet2.intake_manifold_pressure);
  EXPECT_EQ(packet_in.intake_manifold_temperature,
            packet2.intake_manifold_temperature);
  EXPECT_EQ(packet_in.cylinder_head_temperature,
            packet2.cylinder_head_temperature);
...
TEST(ardupilotmega_interop, RPM) {
  ...
  mavlink_rpm_t packet_c{17.0, 45.0};
...
TEST(ardupilotmega_interop, DEVICE_OP_READ) {
  ...
  mavlink_device_op_read_t packet_c{963497464,
                                    17,
                                    84,
                                    151,
                                    218,
...
TEST(ardupilotmega, DEVICE_OP_WRITE) {
  ...
  packet_in.regstart = 216;
  packet_in.count = 27;
  packet_in.data = {{94,  95,  96,  97,  98,  99,  100, 101, 102, 103, 104, 105,
...
TEST(ardupilotmega_interop, DEVICE_OP_WRITE_REPLY) {
  ...
  mavlink_device_op_write_reply_t packet_c{963497464, 17};
...
TEST(ardupilotmega_interop, ADAP_TUNING) {
  ...
  mavlink_adap_tuning_t packet_c{17.0,  45.0,  73.0,  101.0, 129.0,
                                 157.0, 185.0, 213.0, 241.0, 269.0,
                                 297.0, 325.0, 149};
...
TEST(ardupilotmega_interop, VISION_POSITION_DELTA) {
  ...
  mavlink_vision_position_delta_t packet_c{93372036854775807ULL,
...
TEST(ardupilotmega_interop, AOA_SSA) {
  ...
  mavlink_aoa_ssa_t packet_c{93372036854775807ULL, 73.0, 101.0};
...
TEST(ardupilotmega_interop, ESC_TELEMETRY_1_TO_4) {
  ...
  mavlink_esc_telemetry_1_to_4_t packet_c{
      ...
      {18067, 18068, 18069, 18070}, {18483, 18484, 18485, 18486},
      {18899, 18900, 18901, 18902}, {125, 126, 127, 128}};
