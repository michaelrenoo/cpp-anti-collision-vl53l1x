...
{
   MAV_CMD_NAV_WAYPOINT=16, /* Navigate to waypoint. |1: Hold time. (ignored by fixed wing, time to stay at waypoint for rotary wing)| 2: , the waypoint counts as reached)| 3: 0 radius to pass by WP. Positive value for clockwise orbit, negative value for counter-clockwise orbit. Allows trajectory control.| 4: Desired yaw angle at waypoint (rotary wing). NaN for unchanged.| 5: Latitude| 6: Longitude| 7: Altitude|  */
   ...
   MAV_CMD_NAV_TAKEOFF=22, /* Takeoff from ground / hand |1: sor| 2: Empty| 3: Empty| 4: Yaw angle (if magnetometer present), ignored without magnetometer. NaN for unchanged.| 5: Latitude| 6: Longitude| 7: Altitude|  */
   ...
   MAV_CMD_NAV_PATHPLANNING=81, /* Control autonomous path planning on the MAV. |1: 0: Disable local obstacle avoidance / local path planning (without resetting map), 1: Enable local path planning, 2: Enable and reset local path planning| 2: e and reset planned route, but not occupancy grid| 3: Empty| 4: Yaw angle at goal| 5: Latitude/X of goal| 6: Longitude/Y of goal| 7: Altitude/Z of goal|  */
   ...
   MAV_CMD_DO_DIGICAM_CONFIGURE=202, /* Configure digital camera. This is a fallback message for systems that have not yet implemented PARAM_EXT_XXX messages and camera definition files (see https://mavlink.io/en/services/camera_def.html ). |1: Modes: P, TV, AV, M, Etc.| 2: Shutter speed: Divisor number for one second.| 3: Aperture: F stop number.| 4: ISO number e.g. 80, 100, 200, Etc.| 5: Exposure type enumerator.| 6: ommand Identity.| 7: Main engine cut-off time before camera trigger. (0 means no cut-off)|  */
   ...
   MAV_CMD_DO_MOUNT_CONFIGURE=204, /* Mission command to configure a camera or antenna mount |1: Mount operation mode| 2: stabilize roll? (1 = yes, 0 = no)| 3: stabilize pitch? (1 = yes, 0 = no)| 4: stabilize yaw? (1 = yes, 0 = no)| 5: ular rate, 2 = angle absolute frame)| 6: pitch input (0 = angle body frame, 1 = angular rate, 2 = angle absolute frame)| 7: yaw input (0 = angle body frame, 1 = angular rate, 2 = angle absolute frame)|  */
   ...
   MAV_CMD_PREFLIGHT_REBOOT_SHUTDOWN=246, /* Request the reboot or shutdown of system components. |1: 0: Do nothing for autopilot, 1: Reboot autopilot, 2: Shutdown autopilot, 3: Reboot autopilot and keep it in the bootloader until upgraded.| 2: 0: Do nothing for onboard computer, 1: Reboot onboard computer, 2: Shutdown onboard computer, 3: Reboot onboard computer and keep it in the bootloader until upgraded.| 3: era and keep it in the bootloader until upgraded| 4: WIP: 0: Do nothing for mount (e.g. gimbal), 1: Reboot mount, 2: Shutdown mount, 3: Reboot mount and keep it in the bootloader until upgraded| 5: Reserved, send 0| 6: Reserved, send 0| 7: WIP: ID (e.g. camera ID -1 for all IDs)|  */
   ...
   MAV_CMD_DO_TRIGGER_CONTROL=2003, /* Enable or disable on-board camera triggering system. |1: Trigger enable/disable (0 for disable, 1 for start), -1 to ignore| 2: 1 to reset the trigger sequence, -1 or 0 to ignore| 3: off or retracting it. -1 to ignore| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   ...
   MAV_CMD_VIDEO_STOP_STREAMING=2503, /* Stop the given video stream |1: etc.)| 2: Reserved| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
   ...
   MAV_CMD_PAYLOAD_CONTROL_DEPLOY=30002, /* Control the payload deployment. |1: tion mode. 0: Abort deployment, continue normal mission. 1: switch to payload deployment mode. 100: delete first payload deployment request. 101: delete all payload deployment requests.| 2: Reserved| 3: Reserved| 4: Reserved| 5: Reserved| 6: Reserved| 7: Reserved|  */
   ...
   MAV_CMD_SPATIAL_USER_1=31005, /* User defined spatial item. Ground Station will not show the Vehicle as flying through this item. Example: ROI item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: gitude unscaled| 7: Altitude (MSL), in meters|  */
   ...
   MAV_CMD_SOLO_BTN_FLY_HOLD=42002, /* FLY button has been held for 1.5 seconds. |1: altitude.| 2: Empty.| 3: Empty.| 4: Empty.| 5: Empty.| 6: Empty.| 7: Empty.|  */
   ...
   MAV_CMD_DO_START_MAG_CAL=42424, /* Initiate a magnetometer calibration. |1: uint8_t bitmask of magnetometers (0 means all).| 2: Automatically retry on failure (0=no retry, 1=retry).| 3: Save without user input (0=require input, 1=autosave).| 4: Delay (seconds).| 5: Autoreboot (0=user reboot, 1=autoreboot).| 6: Empty.| 7: Empty.|  */
